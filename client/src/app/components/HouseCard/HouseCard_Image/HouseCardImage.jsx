...
const HouseCardImage = (props) => {
  ...
  <div onClick={props.handleOpenModal} className="absolute w-10 z-20 bottom-4 left-4 bg-gray-300 transition-all p-1 rounded-full hover:bg-white hover:shadow-sm hover:shadow-white max-w-lg max-h-10 overflow-hidden">
