...
const FiltrosModal = ({ modalFiltros, setModalFiltros }) => {
  ...
  return (
    <div className='z-[200] w-screen h-screen flex justify-center items-center bg-[#00000080] fixed top-0 left-0 pt-[16px]'>
      <div className='w-screen h-[95%] flex justify-center items-center fixed top-0 left-0 pt-[16px] fade-in-bottom' ref={animContainer}>
        <form className='z-[300] w-full h-full bg-white rounded-lg md:w-[750px] md:h-[680px] overflow-y-scroll scrollbar-hide relative top-0 left-0' onSubmit={handleSubmit}>
